            ...
            <div class="col-md-7">
                <form action="/item?id=<?= htmlspecialchars($item[0]['id']) ?>" method="post">
                    <div class="single-product-details">
                        ...
                        <p class="product-price">VND<?= number_format($item[0]['price'], 2) ?></p>
                        ...
                        <div class="product-Số lượng">
                            <span>Số lượng:</span>
                            <div class="product-Số lượng-slider">
                                <input id="product-Số lượng" type="number" min=1 value="1" name="Số lượng">
                            </div>
                        </div>
